...
<div class="container mt-5">
    ...
    <form method="POST" action="modules/quanLyDanhMucSanPham/xuly.php?id_danhmuc=<?php echo $_GET['id_danhmuc'] ?>" id="categoryForm">
        <div class="mb-3">
            <label for="tendanhmuc" class="form-label">Tên Danh Mục</label>
            <input type="text" class="form-control" id="id_danhmuc" value="<?php echo $dong['id_danhmuc'] ?>" name="id_danhmuc">
        </div>
